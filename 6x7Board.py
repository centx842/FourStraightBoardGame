...
class FourStraightGame(Tiles):
    ...
    # Modify: Only draw 4 in a row, column, or diagonal
    ...
    # Modify: Draw a circle in case of a tie game
    ...
    # Modify: Check for 4 in a row, column, or diagonal
